...
setup(
    name="azul-plugin-ghidra",
    description="Extracting Features From A Binary Using Ghidra Headless.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_plugin_ghidra"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-plugin-ghidra = azul_plugin_ghidra.main:main",
        ]
    },
